...
import com.example.viewflipper_cricleindicator.adapter.ImagesViewPageAdapter;
...
public class CircleIndicatorActivity extends AppCompatActivity {
    ...
    private List<Images> getListImages() {
        ...
        list.add(new Images(R.drawable.sky));
        list.add(new Images(R.drawable.butter));
        list.add(new Images(R.drawable.luffy));
        list.add(new Images(R.drawable.red));
        return list;
    }
}